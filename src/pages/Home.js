                    ...
                    <div className="items-center justify-center items-start mx-auto max-w-[1250px]">
                        <div className="flex flex-col lg:flex-row justify-center relative">
                            ...
                            <div className="relative mx-auto lg:absolute flex-[0_0_auto] max-w-[310px] xxs:max-w-[460px] w-[469px] left-auto lg:top-[-55%] h-[535px] right-[0] bottom-0">
                                <img className={clsx("shadow-2xl h-[82px] w-[82px] xxs:h-[100px] xxs:w-[100px] absolute left-[22px] top-[6%] xxs:left-[66px] xxs:top-[4%] right-auto bottom-auto animate-hover-short", links[0].classes || "")} src={links[0].link} alt={links[0].name} title={links[0].name}/>
                                <img className={clsx("shadow-2xl h-[100px] w-[100px] xxs:h-[144px] xxs:w-[144px] absolute left-auto top-0 right-[60px] xxs:right-[49px] bottom-auto animate-hover-medium", links[1].classes || "")} src={links[1].link} alt={links[1].name} title={links[1].name}/>
                                <img className={clsx("shadow-2xl h-[90px] w-[90px] xxs:h-[124px] xxs:w-[124x] absolute left-auto xxs:w-auto top-[28%] xxs:top-[32%] right-[-3%] bottom-0 animate-hover-long", links[2].classes || "")} src={links[2].link} alt={links[2].name} title={links[2].name}/>
                                <img className={clsx("shadow-2xl h-[125px] w-[125px] xxs:h-[182px] xxs:w-[182px] absolute left-[-2%] xxs:left-0 top-[27%] xxs:top-[31%] right-auto bottom-[29%] animate-hover-medium", links[3].classes || "")} src={links[3].link} alt={links[3].name} title={links[3].name}/>
                                <img className={clsx("shadow-2xl h-[70px] w-[70px] xxs:h-[90px] xxs:w-[90px] absolute left-[8%] xxs:left-[15%] top-auto right-auto bottom-[31%] xxs:bottom-[10%] animate-hover-short", links[4].classes || "")} src={links[4].link} alt={links[4].name} title={links[4].name}/>
                                <img className={clsx("shadow-2xl h-[85px] w-[85px] xxs:h-[110px] xxs:w-[110px] absolute left-[41%] xxs:left-[44%] top-auto right-auto bottom-[40%] xxs:bottom-[23%] animate-hover-long", links[5].classes || "")} src={links[5].link} alt={links[5].name} title={links[5].name}/>
                                <img className={clsx("shadow-2xl h-[75px] w-[75px] xxs:h-[84px] xxs:w-[84px] absolute left-auto top-auto right-0 xxs:right-[6%] bottom-[34%] xxs:bottom-[8%] animate-hover-short", links[6].classes || "")} src={links[6].link} alt={links[6].name} title={links[6].name}/>
                                <img className={clsx("shadow-2xl h-[100px] w-[100px] absolute left-[34%] xxs:left-[42%] top-auto right-0 bottom-[18%] xxs:bottom-0 animate-hover-medium", links[7].classes || "")} src={links[7].link} alt={links[7].name} title={links[7].name}/>
                                <img className={clsx("shadow-2xl h-[65px] w-[65px] xxs:h-[75px] xxs:w-[75px] absolute left-auto top-[25%] xxs:top-[35%] right-[34%] bottom-[33%] animate-hover-long", links[8].classes || "")} src={links[8].link} alt={links[8].name} title={links[8].name}/>
                            </div>
                        </div>
                    </div>
                </section>
